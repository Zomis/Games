...
class BlockingGameListener: GameListener {
    ...
    suspend fun <T: Any, P: Any> createAction(playerIndex: Int, type: ActionType<T, P>, parameter: P): Actionable<T, P> {
        await()
        ...
        return actionType.createAction(playerIndex, parameter)
    }
